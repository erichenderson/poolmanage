...
class PoolsControllerTest < ActionController::TestCase
  ...
  test "should create pool" do
    assert_difference('Pool.count') do
      post :create, pool: { addressline1: @pool.addressline1, addressline2: @pool.addressline2, belongsto: @pool.belongsto, city: @pool.city, poolname: @pool.poolname, state: @pool.state }
    end
  ...
  test "should update pool" do
    patch :update, id: @pool, pool: { addressline1: @pool.addressline1, addressline2: @pool.addressline2, belongsto: @pool.belongsto, city: @pool.city, poolname: @pool.poolname, state: @pool.state }
    assert_redirected_to pool_path(assigns(:pool))
  end
